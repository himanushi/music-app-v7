...
export type AlbumsQuery = { readonly items?: ReadonlyArray<{ readonly id: string, readonly name: string, readonly artworkM?: { readonly url?: string | undefined } | undefined }> | undefined };
